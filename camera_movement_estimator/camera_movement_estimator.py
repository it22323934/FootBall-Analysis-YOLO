...
import os
sys.path.append('..')
from util.bbox_utils import measure_distance, measure_xy_distance,get_center_of_bbox,get_bbox_width,get_foot_position
...
class CameraMovementEstimator():
    ...
    def get_camera_movement(self, frames, read_from_stub=False, stub_path=None):
        ...
        # This is going to extract the features from the first frame
